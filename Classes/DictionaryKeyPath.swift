...
//  Pods
//
//  Created by Borja Álvaro González Jurado on 11/02/2018.
//
// From: GitHubGist dfrib/DictionaryKeyPath.swift
...
extension Dictionary {
    ...
    static private func keyPathKeys(forKeyPath: String) -> [Key]? {
        let keys = forKeyPath.components(separatedBy: ".").reversed().flatMap({ $0 as? Key })
